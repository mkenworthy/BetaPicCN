...
\begin{figure}
    \begin{centering}
        ...
        \caption{Plot of the stacked spectrum in the comet rest frame (blue) with a CN model for $T=$300K and N=10$^{14}$\,cm$^{-2}$ overplotted in orange. The large signal around 3860\AA{} is due to the residual from a circumstellar \ion{Fe}{I} line.}
