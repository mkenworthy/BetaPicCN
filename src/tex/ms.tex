...
\begin{figure}
    \begin{centering}
        ...
        \caption{Similar to Figure~\ref{fig:spec_CN_stellar_frame} but spectra are stacked in the rest frame of the comet. The large signal around 3860\AA{} is due to the residual from a circumstellar \ion{Fe}{I} line.}
...
%
We masked the lines detected in \citep{Kiefer2018}, using a width of $\pm$0.35~$\AA$ for the \ion{Fe}{I} 3859.9$\AA$ line, while for the other lines a width of $\pm$0.15$\AA$ was used.
...
%
These are consistent with the measured scale lengths above if the parents of \ce{CN} are ejected at $\sim 0.5$ \kms{}, and we take into account the excess photodissociation energy giving \ce{CN} an extra kick of $\simeq0.9$ \kms{} \citep{Fray2005}. 
