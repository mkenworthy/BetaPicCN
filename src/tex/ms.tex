...
% 5 {} token are mandatory
  ...
  % methods heading (mandatory)
   {By splitting over twenty year's worth of \ac{harps} spectra into ones with strong \ac{feb} features, and others with little to no \ac{feb} absorption.  We shift and stack the spectra of FEBs on the deepest part of the CaII make a high signal to noise ratio spectrum and search for the \ce{CN} band head using a model temperature dependent cross-correlation template.
   }
  % results heading (mandatory)
   {We do not detect CN in our data, and place a temperature and broadening dependent 5$\sigma$ upper limit between 10$^{12}$\,cm$^{-2}$ and 10$^{13}$\,cm$^{-2}$, which is 100 times higher than seen for comets in our Solar System.%No \ce{CN} is seen to a level of XXX ppt, indicating that there is less \ce{CN} in these \ac{feb} than Solar system comets.
   %
   }
...
%
Comets deliver volatiles across many different distances within the Solar system, from the outermost reaches of the Oort cloud in to the terrestrial planets.
%
...
%
Additionally, a tail of \ion{Fe}{i} atoms was proposed to explain a linear feature imaged in the tail of sungrazing comet C/2016~P1 McNaught 2006P1 \citep{Fulle2007} and Na and K were detected for comet C/2011 L4 \citep{Fulle13}. 
